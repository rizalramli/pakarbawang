...
class Perhitungan extends CI_Controller
{
    ...
    {
        $this->load->view('user/print_perhitungan');
    }
    ...
    public function simpanHasil()
    {
        ...
        if ($sql) {
            // $data_konsultasi['konsultasi'] = $this->MPerhitungan->getWhereOrderBy(array('Nm_user' => $this->session->userdata("nama") ),'konsultasi')->result();
            // $this->load->view('user/print_perhitungan', $data_konsultasi);
