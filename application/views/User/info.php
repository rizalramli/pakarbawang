...
<body>
    ...
    <section class="alazea-portfolio-area portfolio-page section-padding-0-100">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <p style="color: black">Klik masing-masing gambar untuk mengetahui info lebih lanjut</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div style="color: black" class="alazea-portfolio-filter">
                        <div class="portfolio-filter">
                            <?php
                            $no = 1;
                            foreach ($penyakit as $data) {
                            ?>
                                <a href="<?php echo site_url('infopenyakit/index/' . $data->Kd_penyakit) ?>" class="btn active">
                                    <img src="../upload/<?php echo $data->foto; ?>" alt="" width="200"> <br> <?php echo $data->Nm_penyakit; ?>
                                </a>
                            <?php } ?>
                        </div>
                    </div>
